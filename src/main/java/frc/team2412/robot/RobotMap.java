...
public class RobotMap {
	...
	private final static int LEFT_FRONT_ID = 0;
	private final static int LEFT_BACK_ID = 0;
	private final static int RIGHT_FRONT_ID = 0;
	private final static int RIGHT_BACK_ID = 0;
	...
	// climb Pneumatics
	private final static int pneumatic1Open = 1;
	private final static int pneumatic1Closed = 2;
	private final static int pneumatic2Open = 3;
	private final static int pneumatic2Closed = 4;
	...
	// Motors
	private final static int climbMotor1 = 1;
	private final static int climbMotor2 = 2;
	...
	// Turret Subsystem
	private final static int turretMotorID = 1;
	public static WPI_TalonSRX turretMotor = new WPI_TalonSRX(turretMotorID);

	// Flywheel subsystem
	private final static int flywheelMotorID1 = 0;
	private final static int flywheelMotorID2 = 2;
	...
	// Hood Subsystem
	private final static int HOOD_SERVO_PORT = 1;
	public static Servo hoodServo = new Servo(HOOD_SERVO_PORT);

	// Intake DoubleSolenoid Ports
	private final static int INTAKE_UP_PORT = 1;
	private final static int INTAKE_DOWN_PORT = 1;

	public static DoubleSolenoid intakeUpDown = new DoubleSolenoid(INTAKE_UP_PORT, INTAKE_DOWN_PORT);

	private final static int INTAKE_FRONT_PORT = 1;
	private final static int INTAKE_BACK_PORT = 2;
	...
	private final static int LIFT_UP_PORT = 1;
	private final static int LIFT_DOWN_PORT = 1;
	...
	private final static int CONTROL_PANEL_MOTOR_PORT = 1;
