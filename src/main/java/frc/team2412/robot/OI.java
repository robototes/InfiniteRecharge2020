...
public class OI {
	...
	public OI() {
		...
		climbPneumatics.whenPressed(new ClimbCommand(RobotMap.robotContainer.m_ClimbLiftSubsystem));
		manualClimb.whileHeld(new ClimbRails(RobotMap.robotContainer.m_ClimbMotorSubsystem));
