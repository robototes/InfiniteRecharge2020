...
public class IndexSpitBackCommand extends CommandBase {
	...
	public IndexSpitBackCommand(IndexerSubsystemSuperStructure motorSubsystem, IntakeMotorSubsystem intakeOnOffSubsystem, boolean useLift) {
