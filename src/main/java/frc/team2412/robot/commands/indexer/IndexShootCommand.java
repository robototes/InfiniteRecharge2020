...
public class IndexShootCommand extends SequentialCommandGroup {
	...
	public IndexShootCommand(IndexerSensorSubsystem indexerSensorSubsystem, IndexerMotorSubsystem indexMotorSubsystem, IndexerLiftMotorSubsystem indexerLiftMotorSubsystem,
		...
		addCommands(new IndexFrontShootCommand(indexMotorSubsystem, intakeSubsystem, indexerLiftMotorSubsystem),
				new ConditionalCommand(new WaitCommand(3), new WaitCommand(0),
						indexerSensorSubsystem::allFrontSensorsOff),
				new IndexBackShootCommand(indexMotorSubsystem, intakeSubsystem, indexerLiftMotorSubsystem), new WaitCommand(2));
	}

	@Override
	public void initialize() {
		super.initialize();
		m_indexerLiftMotorSubsystem.setLifting(true);
	}

	@Override
	public void end(boolean cancel) {
		m_indexerLiftMotorSubsystem.setLifting(false);
