...
public class LiftSubsystem extends SubsystemBase {
	...
	//For when we create a liftSubsystem, it makes a liftSubsystem which uses our local liftSubsystem
	...
	//Takes the passed in LiftState and set the motor to that value. Also changes the current state to that state
